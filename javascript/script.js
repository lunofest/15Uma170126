...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '541125358240'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '541135064055'; // Número para el primer botón
  const recipientNumber2 = '541125358240'; // Número para el segundo botón
